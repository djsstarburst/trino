        ...
        implements UpdatablePageSource
{
    ...
    public interface ColumnAdaptation
    {
        ...
        static ColumnAdaptation mergeRowIdColumn(UUID shardUuid)
        {
            return new MergeRowIdColumn(shardUuid);
        }
            ...
            implements ColumnAdaptation
    {
        ...
        public MergeRowIdColumn(UUID shardUuid)
        {
        ...
        public Block block(Page sourcePage, long filePosition)
        {
            ...
            return RowBlock.fromFieldBlocks(
                    ...
                    Optional.empty(),
                    new Block[] {shardUuidBlock, rowIdBlock});
        }
    }
