...
public class TestTestbedMetadata
{
    private TestbedMetadata metadata;

    @BeforeMethod
    public void setUp()
    {
        metadata = new TestbedMetadata(new TestingNodeManager());
    }
    ...
    public void testActiveTableIds()
    {
        ...
        TestbedTableHandle firstTableHandle = (TestbedTableHandle) metadata.getTableHandle(SESSION, firstTableName);
        ...
        TestbedTableHandle secondTableHandle = (TestbedTableHandle) metadata.getTableHandle(SESSION, secondTableName);
