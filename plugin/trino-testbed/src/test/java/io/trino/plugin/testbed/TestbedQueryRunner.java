...
public final class TestbedQueryRunner
{
    private static final String CATALOG = "memory";

    private TestbedQueryRunner() {}
            ...
            throws Exception
    {
        ...
        try {
            queryRunner.installPlugin(new TestbedPlugin());
            ...
            throws Exception
    {
        ...
        Thread.sleep(10);
        Logger log = Logger.get(TestbedQueryRunner.class);
