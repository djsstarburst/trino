        ...
        extends AbstractTestQueryFramework
{
    ...
    protected QueryRunner createQueryRunner()
            throws Exception
    {
        return TestbedQueryRunner.createQueryRunner(
    ...
    {
        int tablesBeforeCreate = listTestbedTables().size();
        assertUpdate("CREATE TABLE test AS SELECT * FROM tpch.tiny.nation", "SELECT count(*) FROM nation");
        assertEquals(listTestbedTables().size(), tablesBeforeCreate + 1);

        assertUpdate("DROP TABLE test");
        assertEquals(listTestbedTables().size(), tablesBeforeCreate);
    }
    ...
    public void testCreateTableAndViewInNotExistSchema()
    {
        ...
        int tablesAfterCreate = listTestbedTables().size();
    ...
    private List<QualifiedObjectName> listTestbedTables()
    {
