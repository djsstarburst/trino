...
public class TestbedConfig
{
    ...
    public TestbedConfig setSplitsPerNode(int splitsPerNode)
    {
    ...
    public TestbedConfig setMaxDataPerNode(DataSize maxDataPerNode)
    {
    ...
    public TestbedConfig setEnableLazyDynamicFiltering(boolean enableLazyDynamicFiltering)
    {
